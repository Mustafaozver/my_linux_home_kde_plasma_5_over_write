...
ColumnLayout {
    RowLayout{
        ...
        PlasmaComponents.Button{
            ...
            PlasmaComponents.Button{
            iconSource: "go-home"
            onClicked: webview.url = "https://bestpwa.com/kde-plasmoid-bestpwa/"
        }
            PlasmaComponents.Button{
            iconSource: "list-add"
            onClicked: webview.url = "https://bestpwa.com/add/"
        }
        PlasmaComponents.TextField{
            ...
            onAccepted: {
                var url = text;
                if (url.indexOf(":/") < 0) {
                    url = "https://bestpwa.com/kde-plasmoid-bestpwa/?search_90834=" + url;
                }
                webview.url = url;
            }
    ...
    Item {
        ...
        Layout.preferredWidth: units.gridUnit * 1000 
        Layout.preferredHeight: units.gridUnit * 1000
